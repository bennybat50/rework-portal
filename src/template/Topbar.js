    ...
    return (
        <div>
                 ...
                 <nav className="navbar navbar-expand navbar-light  topbar mb-4 static-top  ">
                     ...
                     <h5 className="h5 topbar-heading">Widgets</h5>
                     ...
                     <ul className="navbar-nav ml-auto">
                        ...
                        <li className="nav-item dropdown no-arrow profile-drop">
                            <a className="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img className="img-profile rounded-circle" src="assets/img/profile-default.png"/>
                            </a>
                            <div className="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a className="dropdown-item text-danger" href="#" data-toggle="modal"
                                    data-target="#logoutModal">
                                     <LogOut className="mr-2 text-danger " size={18}/>
                                    Logout
                                </a>
                            </div>
                        </li>
